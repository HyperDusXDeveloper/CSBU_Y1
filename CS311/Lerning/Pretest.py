...
master.mainloop()
    ...
    # Label(center,text="Dream\nCake",bg="#FFF7B7",font=('comic sans ms',30,'bold')).grid(rowspan=2 , columnspan=2,sticky='news',padx=50 ,pady=50)

    # Label(left,image=img1).grid(row=0 , column=0,sticky='news')