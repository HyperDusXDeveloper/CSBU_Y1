...
#main
master = createwindow()
toy1 = PhotoImage(file='week3 CS311/image/skullpanda.png').subsample(3,3)
toy2 = PhotoImage(file='week3 CS311/image/dimoo.png').subsample(3,3)
toy3 = PhotoImage(file='week3 CS311/image/crybaby.png').subsample(2,2)
icon = PhotoImage(file='week3 CS311/image/icon1.png')
