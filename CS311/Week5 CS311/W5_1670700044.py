...
def mainwindow() :
    root = Tk()
    root.title("Class Activity of Week5 : Dream cake cafe by Natchanon Saileamonpiwat")
...
def topside(top) :
    title = Label(top,text="Dream House Cafe by Natchanon Saileamonpiwat",font=("Garamond",22),bg="#854836",fg='white')
    title.grid(row=0)
...
def leftside(left) :
    ...
    for i,cake in enumerate(cakemenu):
        Label(left,bg='#F7F7F7',image=cakelist[i]).grid(row=i ,column=0)
        Label(left,bg='#F7F7F7',text=cake).grid(row=i,column=1)
...
def rightside(right) :
    ...
    for i,drink in enumerate(drinkmenu):
        Label(right,bg='#FFB22C',image=drinklist[i]).grid(row=i,column=0)
        Label(right,bg='#FFB22C',text=drink).grid(row=i,column=1)
...
def bottomside(bottom) :
    showcake = Label(bottom,bg='#854836')
    showcake.grid(row=0,column=0)
    showdrink = Label(bottom,bg='#854836')
...
def userclick() :
    ...
    showcake['bg'] = "#854836"
    showcake['fg'] = "white"
    showdrink['text'] = f'Total Price = {totaldrink:0.2f} Bath'
    showdrink['bg'] = "#854836"
    showdrink['fg'] = "white"
#main program
master = mainwindow()
top,bottom,left,right = layout(master)
cake1 = PhotoImage(file="Week5 CS311/image/cake1.png")
cake2 = PhotoImage(file="Week5 CS311/image/cake2.png")
cake3 = PhotoImage(file="Week5 CS311/image/cake3.png")
cake4 = PhotoImage(file="Week5 CS311/image/cake4.png")
drink1 = PhotoImage(file="Week5 CS311/image/coffee1.png")
drink2 = PhotoImage(file="Week5 CS311/image/coffee2.png")
drink3 = PhotoImage(file="Week5 CS311/image/coffee3.png")
drink4 = PhotoImage(file="Week5 CS311/image/coffee4.png")
