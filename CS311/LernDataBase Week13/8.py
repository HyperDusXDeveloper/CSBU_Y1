...
def welcomepage(result) :
    ...
    #LEFT
    botton = Frame(welcomeframe,bg='#BDDDE4')
    botton.grid_rowconfigure(0,weight=1)
    botton.grid_columnconfigure((0,1,2,3),weight=1)
    botton.grid(row=2,column=0,columnspan=2,sticky='news')
    
    #RIGHT
    bottom = Frame(welcomeframe,bg='#9EC6F3')
    ...
    Button(botton,text="Add Course",width=10,command=addclick).grid(row=0,column=0,ipady=10)
    Button(botton,text="Update Course",width=10,command=updateclick).grid(row=0,column=1,ipady=10)
    Button(botton,text="Delete Course",width=10,command=deleteclick).grid(row=0,column=2,ipady=10)
    Button(botton,text="Logout",width=10,command=logoutclick).grid(row=0,column=3,ipady=10)
    Label(bottom,image=img4,bg='#BDDDE4').grid(row=0,column=0)
