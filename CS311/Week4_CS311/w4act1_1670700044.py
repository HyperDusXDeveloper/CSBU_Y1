...
def createwindow() :
    ...
    master.title("Week4 : Dream Bekery Shop by Natchanon Saileamonpiwat")
...
def widgets(top,left,right,bottom) :
    heading = Label(top,text="Dream Bekery Shop by Natchanon Saileamonpiwat",fg='blue',font=('comic sans ms',32,'bold'),bg='#E5989B')
    ...
    amount1 = Spinbox(left,from_=0,to=100,justify="center",textvariable=spy1,command=userclick)
    ...
    amount2 = Spinbox(left,from_=0,to=100,justify="center",textvariable=spy2,command=userclick)
    ...
    amount3 = Spinbox(left,from_=0,to=100,justify="center",textvariable=spy3,command=userclick)
...
def userclick() :
    ...
    total['text'] = f"Total Price = {net:0.2f} Bath "
#main
master = createwindow()
