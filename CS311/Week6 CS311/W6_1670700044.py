...
def cakeclick() :
    ...
    for i,cake in enumerate(cakemenu) :
        ...
        Entry(cright,font=('tahoma',16,'bold'),width=15,justify='center',textvariable=cakespy[i]).grid(row=i,column=1,sticky='W')
...
def drinkclick() :
    ...
    for i,drink in enumerate(drinkmenu) :
        ...
        Entry(dright,font=('tahoma',16,'bold'),width=15,justify='center',textvariable=drinkspy[i]).grid(row=i,column=1,sticky='W')
