...
grade_instead = {"A" : 4.0 ,"B+" : 3.5 ,"B" : 3.0 ,"C+" : 2.5 ,"C" : 2.0 ,"D+" : 1.5 ,"D" : 1.0 ,"F" : 0.0 }
...
for i in range(total_sub):
    ...
    grade_instead = grade_instead.get(glist[i], 0.0)  # Default to 0.0 if grade is not found
    stotal += grade_instead * clist[i]
    ctotal += clist[i]
