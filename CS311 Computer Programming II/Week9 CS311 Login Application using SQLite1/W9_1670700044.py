...
def welcomepage(name):
    ...
    Label(top2,text="Welcome to my Application",font=('garamond',32,'bold'),fg='white',bg='#493628').grid(row=0,column=0)
    welcome.grid(row=1,sticky='news')
    welcome.grid_rowconfigure((0,1),weight=1)
    welcome.grid_columnconfigure((0,1),weight=1)
    Label(welcome,image=img2,bg='#D6C0B3').grid(row=0,column=0,rowspan=2)
    Label(welcome,text="Information : \n"+name,bg="#D6C0B3").grid(row=0,column=1,sticky=S)
    Button(welcome,text="Exit Program",command=quit,width=15).grid(row=1,column=1)
#main
